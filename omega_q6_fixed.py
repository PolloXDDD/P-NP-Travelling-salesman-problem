...
def _q6_canonical_cycle(cyc):
    """
    Canonicalize a DIRECTED cycle only by cyclic rotation.

    Reversal is NOT equivalent in the directed exchange graph:
        u->v and v->u can have different weights or one arc may not exist.
    """
    cyc=list(cyc)
    m=len(cyc)
